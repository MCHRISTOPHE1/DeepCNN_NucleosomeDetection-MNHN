...
file = "mse_mut_mAg15_1"
#                     multi= True, offset=1000, save=True, result=True, step=[500,750,1000,1250,1500], reverse = True)
with strategy.scope():
    model = tf.keras.models.load_model(f"/home/maxime/data/mnase/train/mA_gauss15_chem5H_250_rep2/best.h5", custom_objects={"mae_cor": mae_cor, "correlate": correlate})
    for chr in range(14, 20):
        seq = np.load(f"/home/maxime/data/sequences/mm10/one_hot/chr{chr}.npz")["arr_0"]
        lab = np.load(f"/home/maxime/data/mnase/predictions/mA_gauss15_H250_2/RAWRESULT_{chr}__mA_gauss15_chem5H_250_rep2.npz")["arr_0"]
        mse_mutasome(model = model, sequence=seq, labels=lab,
                positions=np.arange(3_000_000, len(seq)-3_000_000), output_file=f"/home/maxime/data/mnase/mutasome/mA_gauss15_chem5H_250_2/{chr}_{file}",
                save=True, result=False, step=[500, 750, 1000, 1250, 1500], multi=True, batch=16384//4)
