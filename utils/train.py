...
from generator_opt import DNAmulti5H, KDNAmulti5H
...
parser.add_argument("--train_reverse",  help = "0: no revcomp., 1: revcomp. only, 2: both ",                  type = int,     default = 0,              required=False, choices=[0,1,2, 3]     )
parser.add_argument("--train_weights",  help = "0: None, 1: array, 2: dict, 3: undersampling, 5: sklearn",    type = bool,     default = True,              required=False)
...
parser.add_argument("--val_reverse",    help = "0: no revcomp., 1: revcomp.  only, 2: both",                  type = int,     default = 0,              required=False, choices=[0,1,2, 3]     )
